...
/**
 * item多类型adapter,不同类型item的bean只需要实现{@link MultiItemEntity}
 *
 * @author: Android 轮子哥
 ...
 */
public class MultiAppAdapter<T extends MultiItemEntity> extends BaseAdapter<BaseAdapter<?>.ViewHolder> implements DefaultLifecycleObserver {
    ...
    public MultiAppAdapter(@NonNull Context context) {
        super(context);
        addObserver(context);
    }
