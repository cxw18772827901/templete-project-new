...
/** Rounded rect + emulated shadow (pre-21 / padding math). Based on AOSP CardView. */
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
        ...
        mShadowStartColor = resources.getColor(R.color.rcv_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.rcv_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.rcv_compat_inset_shadow);
