...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            for (int i = 0; i < ta.getIndexCount(); i++) {
                ...
                }/* else if (attr == R.styleable.RoundImageView_round) {
                    cornerRadius = ta.getDimensionPixelSize(attr, cornerRadius);
                }*/
            }
            ta.recycle();
    ...
    public int dip2px(Context context, double dip) {
        return (int) (dip * getDensity(context) + 0.5f);
    }

    public void setBorderWidth(int borderWidth) {
        this.borderWidth = /*UIUtil.*/dip2px(context, borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.innerBorderWidth = /*UIUtil.*/dip2px(context, innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.cornerRadius = /*UIUtil.*/dip2px(context, cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.cornerTopLeftRadius = /*UIUtil.*/dip2px(context, cornerTopLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.cornerTopRightRadius = /*UIUtil.*/dip2px(context, cornerTopRightRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.cornerBottomLeftRadius = /*UIUtil.*/dip2px(context, cornerBottomLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        this.cornerBottomRightRadius = /*UIUtil.*/dip2px(context, cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
