package com.hjq.shape.view.xtabLayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    private final int xTabIndicatorBottomPadding;
    //文本字母是否小写转大写
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        mTabStrip.setmSelectedIndicatorGravity(a.getBoolean(R.styleable.XTabLayout_xTabIndicatorIsBottom, true));
        xTabIndicatorBottomPadding = a.getDimensionPixelSize(R.styleable.XTabLayout_xTabIndicatorBottomPadding,
                0);
...
//        invalidate();
    ...
    public static final class Tab {
        ...
        public XTabLayout.Tab setIcon(@DrawableRes int resId) {
            ...
            return setIcon(mParent.getContext().getResources().getDrawable(/*mParent.getContext(),*/ resId));
        }
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        ...
        public boolean onLongClick(View v) {
            ...
            Toast cheatSheet = Toast.makeText(context.getApplicationContext(), mTab.getContentDescription(),
                    Toast.LENGTH_SHORT);
            // Show under the tab
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private boolean mSelectedIndicatorIsBottom;
        ...
        public void setmSelectedIndicatorGravity(boolean mSelectedIndicatorIsBottom) {
            if (this.mSelectedIndicatorIsBottom != mSelectedIndicatorIsBottom) {
                this.mSelectedIndicatorIsBottom = mSelectedIndicatorIsBottom;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                //绘制指示器
                int blankHalf = (int) ((getHeight() - mTabSelectedTextSize) / 2);
                int top = getHeight() - mSelectedIndicatorHeight - xTabIndicatorBottomPadding;
                int bottom = getHeight() - xTabIndicatorBottomPadding;
                if (!mSelectedIndicatorIsBottom) {
                    top = top - blankHalf + mSelectedIndicatorHeight + xTabIndicatorBottomPadding + 4;
                    bottom = bottom - blankHalf + mSelectedIndicatorHeight + xTabIndicatorBottomPadding + 4;
                }
                RectF rect = new RectF(mIndicatorLeft, /*getHeight() - mSelectedIndicatorHeight*/top,
                        mIndicatorRight, /*getHeight()*/bottom);
                int roundX = 0;
                int roundY = 0;
    ...
    private int getTabMinWidth() {
        if (mPagerAdapter != null && xTabDisplayNum != 0) {
            ...
            if (mPagerAdapter.getCount() == 1 || xTabDisplayNum == 1) {
                ...
                return (int) (wm.getDefaultDisplay().getWidth() / (xTabDisplayNum + 0.5));
            }
        }
        if (xTabDisplayNum != 0) {
            WindowManager wm = (WindowManager) getContext()
